...
function handleNotificationClick(event) {
  ...
  var clickUrl = 'https://pushdealer.com/projects/f3e2f480/notifications/' + id + '/click';
...
self.addEventListener('push', function(event) {
  event.waitUntil(self.registration.pushManager.getSubscription()
      .then(function(subscription) {
        ...
        var url = 'https://pushdealer.com/projects/f3e2f480/subscriptions/' + encodeURIComponent(regID) + '/notification';
        return fetch(url)
