...
class SliderItem(models.Model):
    ...
    link = models.CharField(max_length=200,
                            ...
                            help_text=u'Ссылка должна быть относительной и начинаться с корня сайта со знака "/" '
...
class Review(models.Model):
    ...
    input_video = models.CharField(max_length=240, verbose_name=u'поле для вставки видео из youtube', blank=True)
    date = models.DateField(verbose_name=u'Дата', default=datetime.datetime.now, editable=True)
...
class Video(models.Model):
    ...
    video = models.CharField(verbose_name=u'ссылка на видео youtube',
                             max_length=200,
                             help_text=u'вводите ссылку на видео которая получается в результате нажатия на кнопку '
                                       u'поделиться в youtube, например "https://youtu.be/t42-71RpRgI?t=1h41m40s" '
                             )
...
class Ministry(models.Model):
    ...
    baner = models.ImageField(verbose_name=u'Изображение для основного банера', upload_to='ministry/images/', blank=True)
